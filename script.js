...
const T = {
  en:{
    ...
    c2:'Orientation & Atrium', c2d:'Solar orientation strategies and the central atrium as a spatial and environmental device.',
    c3:'Urban Situation & Planning', c3d:'The project within the broader urban masterplan of Skopje and the Vardar corridor.',
    c4:'Architecture', c4d:'The full architectural proposition — form, programme, and spatial sequence.',
    c5:'Structure & Statics', c5d:'Structural system, load paths, and material strategy for the tower ensemble.',
    c6:'Technical Details', c6d:'Construction details, connection nodes, and bespoke technical solutions.',
    c7:'Design Strategy', c7d:'The overarching design methodology and strategic design decisions.',
    c8:'Renders', c8d:'Photorealistic visualisations of the completed project across all programmes.',
    c9:'Videos', c9d:'Cinematic walkthroughs and process films for the Altan Nexus project.',
    c10:'QR Interactive Experience', c10d:'Augmented reality and mobile-accessible project exploration via QR codes.',
    c11:'City Context', c11d:'The relationship between Altan Nexus and the city of Skopje.',
    c12:'Final Poster Presentation', c12d:'The complete academic and professional presentation poster for the project.',
  },
  sq:{
    ...
    back_portfolio:'Kthehu te Portfolio',
    ...
    c2:'Orientimi & Atriumi', c2d:'Strategjitë e orientimit solar dhe atriumi qendror si pajisje hapësinore dhe mjedisore.',
    c3:'Situata Urbane & Planifikimi', c3d:'Projekti brenda masterplanit urban më të gjerë të Shkupit dhe korridorit të Vardarit.',
    c4:'Arkitektura', c4d:'Propozimi i plotë arkitekturor — forma, programi dhe sekuenca hapësinore.',
    c5:'Struktura & Statika', c5d:'Sistemi strukturor, rrugët e ngarkesës dhe strategjia e materialeve.',
    c6:'Detajet Teknike', c6d:'Detajet e ndërtimit, nyjet e lidhjes dhe zgjidhjet teknike bespoke.',
    c7:'Strategjia e Dizajnit', c7d:'Metodologjia e përgjithshme e dizajnit dhe vendimet strategjike të projektimit.',
    c8:'Render', c8d:'Vizualizime fotorealiste të projektit të përfunduar nëpër të gjitha programet.',
    c9:'Video', c9d:'Ecje kinematike dhe filma procesi për projektin Altan Nexus.',
    c10:'Eksperienca Interaktive QR', c10d:'Realitet i shtuar dhe eksplorim i projektit i aksesushëm nga celulari.',
    c11:'Konteksti i Qytetit', c11d:'Marrëdhënia midis Altan Nexus dhe qytetit të Shkupit.',
    c12:'Prezantimi Final Poster', c12d:'Posteri i plotë akademik dhe profesional i prezantimit për projektin.',
  },
  mk:{
    ...
    back_portfolio:'Назад кон Портфолио',
    ...
    c2:'Ориентација & Атриум', c2d:'Стратегии за сончева ориентација и централниот атриум.',
    c3:'Урбана Ситуација & Планирање', c3d:'Проектот во рамките на поширокиот урбан мастерплан на Скопје.',
    c4:'Архитектура', c4d:'Целосниот архитектонски предлог — форма, програма и просторна секвенца.',
    c5:'Структура & Статика', c5d:'Структурен систем, патишта на оптоварување и стратегија на материјали.',
    c6:'Технички Детали', c6d:'Детали за изградба, конекциски јазли и специфични технички решенија.',
    c7:'Стратегија на Дизајнот', c7d:'Сеопфатната методологија на дизајнот и стратешките дизајн-одлуки.',
    c8:'Рендери', c8d:'Фотореалистични визуелизации на завршениот проект.',
    c9:'Видеа', c9d:'Кинематски прошетки и процесни филмови за проектот Алтан Нексус.',
    c10:'QR Интерактивно Искуство', c10d:'Проширена реалност и мобилно истражување на проектот.',
    c11:'Градски Контекст', c11d:'Односот меѓу Алтан Нексус и градот Скопје.',
    c12:'Финален Постер', c12d:'Целосниот академски и професионален презентациски постер.',
  }
};
